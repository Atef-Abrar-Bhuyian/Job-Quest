...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2023 at 07:21 PM
...
CREATE TABLE `help_form` (
  `h_u_id` int(10) NOT NULL,
  `h_u_name` varchar(20) NOT NULL,
  `h_u_email` varchar(20) NOT NULL,
  `h_u_subject` varchar(20) NOT NULL,
  `h_u_msg` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `new_jobs` (`new_job_ID`, `Title`, `Description`, `Location`, `Experience`) VALUES
(1, 'Account Manager', 'Excellent communication skills, both spoken and wr', 'Santinagor Mor. Palt', 'At least 5'),
(2, 'Executive (Accounts)', 'Responsible for the full cycle of accounting dutie', 'Anywhere in Banglade', 'At least 2'),
(3, 'Accounts Officer', 'Age 25 to 35 years\r\nOnly males are allowed to appl', 'Dhaka', 'At least 2'),
(4, 'Accounts & Tax Assoc', 'Preparation of UK Personal Tax Returns of Self-emp', 'Chittagong ', 'At least 2'),
(5, 'Executive (Accounts)', 'High Level Expert in Tally-ERP.\r\nMaintain all acco', 'Sylhet.', 'At least 3'),
(6, 'Agricultural Project', 'Diploma in Agriculture from any reputed institute ', 'Cumilla ,Bangladesh', 'At least 2'),
(7, 'Deputy Manager', 'Develop and implement export strategies to achieve', 'Dhaka ,Bangladesh', 'At least 2'),
(8, 'Data Entry Operator', 'The applicants should have experience in the follo', 'Chittagong,Banglades', 'At least 4'),
(9, 'Graphic Designer', 'Bachelor degree in any discipline Preferred Profes', 'Dhaka ,Bangladesh', 'At least 5');
...
--
-- Table structure for table `post_job_form`
--

CREATE TABLE `post_job_form` (
  `p_j_ID` int(10) NOT NULL,
  `applier_name` varchar(20) NOT NULL,
  `applier_mbl_number` varchar(15) NOT NULL,
  `applier_nid` varchar(30) NOT NULL,
  `applier_email` varchar(20) NOT NULL,
  `job_title` varchar(30) NOT NULL,
  `job_descirption` varchar(100) NOT NULL,
  `job_location` varchar(10) NOT NULL,
  `job_experience` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `post_job_form`
--

INSERT INTO `post_job_form` (`p_j_ID`, `applier_name`, `applier_mbl_number`, `applier_nid`, `applier_email`, `job_title`, `job_descirption`, `job_location`, `job_experience`) VALUES
(1, 'Fahimul Islam', '01584887954', '1548796969887457', 'fahimul@gmail.com', 'Accounts', 'aasduahsdhasudhahsdas dasdhvasbdhavshdvbasg dasgd agsd asgd asdfcafsd azfd asfd afs dfas dasv dasdfa', 'Chattogram', '5 years');
...
INSERT INTO `signup` (`User_ID`, `user_name`, `mobile_number`, `email`, `pass`) VALUES
(1, 'Atef', 1548779952, 'atef@gmail.com', 'atef');
...
--
-- Indexes for table `help_form`
--
ALTER TABLE `help_form`
  ADD PRIMARY KEY (`h_u_id`);
...
--
-- Indexes for table `post_job_form`
--
ALTER TABLE `post_job_form`
  ADD PRIMARY KEY (`p_j_ID`);
...
--
-- AUTO_INCREMENT for table `help_form`
--
ALTER TABLE `help_form`
  MODIFY `h_u_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `new_jobs`
  MODIFY `new_job_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- AUTO_INCREMENT for table `post_job_form`
--
ALTER TABLE `post_job_form`
  MODIFY `p_j_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
