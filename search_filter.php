...
<body>
    ...
    <section>
        <h2 class="new-jobs-text"><i class="fa-solid fa-fire" style="color: #5ACEF5;"></i> NEW JOBS</h2>
        <div class="new-jobs">
            <?php
            $alljobs = $_SESSION['alljobs'];
            $row = mysqli_query($con, "Select * from alljobs where Title='$alljobs'");
    ...
    <section class="filter-section">
        ...
        <button class="search-style">Search</button>
    </section>
